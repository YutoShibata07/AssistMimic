        ...
        def load(self, params):
            ...
            if self.has_space:
                ...
                if self.is_continuous:
                    ...
                    # Normalize None activations to string 'None' for activations_factory
                    if self.space_config.get('mu_activation', None) is None:
                        self.space_config['mu_activation'] = 'None'
                    if self.space_config.get('sigma_activation', None) is None:
                        self.space_config['sigma_activation'] = 'None'
...
class A2CResnetBuilder(NetworkBuilder):
    ...
    class Network(NetworkBuilder.BaseNetwork):
        ...
        def load(self, params):
            ...
            if self.is_continuous:
                self.space_config = params['space']['continuous']
                # Normalize None activations to string 'None'
                if self.space_config.get('mu_activation', None) is None:
                    self.space_config['mu_activation'] = 'None'
                if self.space_config.get('sigma_activation', None) is None:
                    self.space_config['sigma_activation'] = 'None'
