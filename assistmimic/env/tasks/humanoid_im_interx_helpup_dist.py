...
class HumanoidImInterxHelpUpDist(HumanoidImInterxHelpUp):
    ...
    def _build_teacher_network(self, checkpoint, _obs_size, action_size):
        ...
        """
        from assistmimic.learning.amp_network_pnn_multi_builder import AMPPNNMultiBuilder
        ...
        # Source: /data/user_data/yutos/MultiLiftUpRL/assistmimic/data/cfg/learning/im_simpleliftup_mlp.yaml
