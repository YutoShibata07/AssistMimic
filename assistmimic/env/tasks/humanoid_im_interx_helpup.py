...
from assistmimic.env.tasks.commons import (
...
class HumanoidImInterxHelpUp(HumanoidIm, RSIMixin):
    ...
    def _load_motion(self, motion_train_file, motion_test_file=[]):
        ...
        if self.humanoid_type in ["smpl", "smplh", "smplx"]:
            ...
            from assistmimic.utils.motion_lib import MotionLib
    ...
    def _save_recipient_phc_obs(self):
        ...
        import atexit
        from assistmimic.env.tasks.humanoid import compute_humanoid_observations_smpl_max
        from assistmimic.env.tasks.humanoid_im import compute_imitation_observations_v6
