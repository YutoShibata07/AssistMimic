import time
import torch
import assistmimic.env.tasks.humanoid as humanoid
from assistmimic.env.tasks.humanoid_amp import remove_base_rot
...
from assistmimic.learning.network_loader import load_z_encoder, load_z_decoder
...
class HumanoidZ(humanoid.Humanoid):
    ...
    def compute_z_actions(self, action_z):
        with torch.no_grad():
            ...
            ######################## Apply Z Encoder ########################
            # import assistmimic.env.tasks.humanoid_im as humanoid_im
